...
from test_configuration import get_test_configuration, TestConfigurationError
...
async def main():
    try:
        ...
        test_config = get_test_configuration(test_suite_dir)
        ...
        for test_suite_path in test_suite_paths:
            try:
                ...
                test_suite_results = await run_test_suite(llm, test_config, test_suite)
